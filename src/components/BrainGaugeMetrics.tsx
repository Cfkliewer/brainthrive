...
export default function BrainGaugeMetrics() {
  ...
  return (
    <section ref={metricsRef} className="py-16 sm:py-20 lg:py-24 bg-gradient-to-br from-purple-50 to-white" aria-label="Brain Gauge Cortical Metrics">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 max-w-6xl mx-auto mb-16">
          {brainGaugeMetrics.map((metric) => (
            <div
              key={metric.name}
              className="metric-card medical-card bg-gradient-to-br from-white to-purple-50 rounded-xl p-6 border-2 border-purple-200 hover:border-purple-400 transition-all duration-300 group hover:shadow-xl"
            >
              <div className="flex flex-col items-center text-center mb-4">
                <div className="w-16 h-16 rounded-xl bg-purple-600 flex items-center justify-center mb-4 group-hover:scale-110 transition-all duration-300 shadow-lg">
              ...
              <details className="group/details">
                <summary className="cursor-pointer text-purple-600 font-medium text-sm hover:text-purple-700 transition-colors list-none">
                ...
                <div className="mt-3 pt-3 border-t border-purple-100">
                  <div className="space-y-3 text-xs text-medical-gray-600">
                    <div>
                      <strong className="text-purple-700">Measurement:</strong>
                      <p className="mt-1">{metric.details}</p>
                    </div>
                    <div>
                      <strong className="text-purple-700">Clinical Use:</strong>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-r from-purple-50 to-blue-50 rounded-xl p-8 border border-purple-100">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="#contact"
                className="bg-purple-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-purple-700 transition-all duration-200 medical-button shadow-lg text-center medical-focus"
              ...
              <a
                href="#services"
                className="bg-transparent border-2 border-purple-600 text-purple-600 px-6 py-3 rounded-lg font-semibold hover:bg-purple-50 transition-all duration-200 text-center medical-focus"
